...
public class DDCLBlocks {
    ...
    public static final BlockEntry<DimmableCageLampBlock> GREEN_ANDESITE_DIMM_LAMP = MOD_REGISTRATE
            ...
            .properties(p -> p.strength(1.0f).mapColor(MapColor.TERRACOTTA_GRAY).noOcclusion().sound(SoundType.LANTERN))
            .simpleItem()
            .register();
    ...
    public static final BlockEntry<DimmableCageLampBlock> GREEN_BRASS_DIMM_LAMP = MOD_REGISTRATE
            ...
            .properties(p -> p.strength(1.0f).mapColor(MapColor.TERRACOTTA_YELLOW).noOcclusion().sound(SoundType.LANTERN))
            .simpleItem()
            .register();
    ...
    public static final BlockEntry<DoubleTextureDimmableCageLampBlock> GREEN_COPPER_DIMM_LAMP = MOD_REGISTRATE
            ...
            .properties(p -> p.strength(1.0f).mapColor(MapColor.TERRACOTTA_ORANGE).noOcclusion().sound(SoundType.LANTERN))
            .simpleItem()
            .register();
